...
import seederData from "./documentItems.seeder.json";
...
const DocumentItemsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DocumentItemsSeederDialogComponent);
