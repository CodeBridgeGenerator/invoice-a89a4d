...
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.unitPrice}</p>
const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.serviceType}</p>
...
<Column field="unitPrice" header="Unit Price" body={pTemplate2} filter={selectedFilterFields.includes("unitPrice")} hidden={selectedHideFields?.includes("unitPrice")}  sortable style={{ minWidth: "8rem" }} />
<Column field="serviceType" header="ServiceType" body={pTemplate3} filter={selectedFilterFields.includes("serviceType")} hidden={selectedHideFields?.includes("serviceType")}  sortable style={{ minWidth: "8rem" }} />
