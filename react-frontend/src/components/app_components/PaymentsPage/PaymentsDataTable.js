...
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.receiptID}</p>
...
<Column field="receiptID" header="Receipt ID" body={pTemplate1} filter={selectedFilterFields.includes("receiptID")} hidden={selectedHideFields?.includes("receiptID")}  sortable style={{ minWidth: "8rem" }} />
