...
const InvoicesPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("invoices")
            .find({ query: { $limit: 10000 , customerID : urlParams.singleCompaniesId ,invoiceItems : urlParams.singleServicesId ,paymentTermsID : urlParams.singlePaymentTermsId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
